The user invoked `/impeccable $ARGUMENTS`. Follow all instructions below.
...
2. If the user invoked a sub-command (`craft`, `shape`, `audit`, `polish`, ...), you MUST read `.agents/skills/impeccable/reference/<command>.md` next. Non-optional. The reference defines the command's flow; without it you will skip steps the user expects.
3. Familiarize yourself with any existing design system, conventions, and components in the code. Read at least one project file (CSS / tokens / theme / a representative component or page). **Required even when you've loaded a sub-command reference in step 2.** Don't reinvent the wheel; use what's there when it works, branch out when the UX wins.
4. Read the matching register reference. **This is non-optional; skipping it produces generic output.** If the project is marketing, a landing page, a campaign, long-form content, or a portfolio (design IS the product), read `.agents/skills/impeccable/reference/brand.md`. If it is app UI, admin, a dashboard, or a tool (design SERVES the product), read `.agents/skills/impeccable/reference/product.md`. Pick by first match: (1) task cue ("landing page" vs "dashboard"); (2) surface in focus (the page, file, or route being worked on); (3) `register` field in PRODUCT.md.
...
- **Second-order:** if someone could guess the aesthetic family from category-plus-anti-references ("AI workflow tool that's not SaaS-cream → editorial-typographic", "fintech that's not navy-and-gold → terminal-native dark mode"), it's the trap one tier deeper. The first reflex was avoided; the second wasn't. Rework until both answers are not obvious. The brand register's reflex-reject aesthetic lanes (`.agents/skills/impeccable/reference/brand.md`) list catches the currently-saturated families.

## Commands

| Command | Category | Description | Reference |
|---|---|---|---|
| `craft [feature]` | Build | Shape, then build a feature end-to-end | `.agents/skills/impeccable/reference/craft.md` |
| `shape [feature]` | Build | Plan UX/UI before writing code | `.agents/skills/impeccable/reference/shape.md` |
| `init` | Build | Set up project context: PRODUCT.md, DESIGN.md, live config, next steps | `.agents/skills/impeccable/reference/init.md` |
| `document` | Build | Generate DESIGN.md from existing project code | `.agents/skills/impeccable/reference/document.md` |
| `extract [target]` | Build | Pull reusable tokens and components into design system | `.agents/skills/impeccable/reference/extract.md` |
| `critique [target]` | Evaluate | UX design review with heuristic scoring | `.agents/skills/impeccable/reference/critique.md` |
| `audit [target]` | Evaluate | Technical quality checks (a11y, perf, responsive) | `.agents/skills/impeccable/reference/audit.md` |
| `polish [target]` | Refine | Final quality pass before shipping | `.agents/skills/impeccable/reference/polish.md` |
| `bolder [target]` | Refine | Amplify safe or bland designs | `.agents/skills/impeccable/reference/bolder.md` |
| `quieter [target]` | Refine | Tone down aggressive or overstimulating designs | `.agents/skills/impeccable/reference/quieter.md` |
| `distill [target]` | Refine | Strip to essence, remove complexity | `.agents/skills/impeccable/reference/distill.md` |
| `harden [target]` | Refine | Production-ready: errors, i18n, edge cases | `.agents/skills/impeccable/reference/harden.md` |
| `onboard [target]` | Refine | Design first-run flows, empty states, activation | `.agents/skills/impeccable/reference/onboard.md` |
| `animate [target]` | Enhance | Add purposeful animations and motion | `.agents/skills/impeccable/reference/animate.md` |
| `colorize [target]` | Enhance | Add strategic color to monochromatic UIs | `.agents/skills/impeccable/reference/colorize.md` |
| `typeset [target]` | Enhance | Improve typography hierarchy and fonts | `.agents/skills/impeccable/reference/typeset.md` |
| `layout [target]` | Enhance | Fix spacing, rhythm, and visual hierarchy | `.agents/skills/impeccable/reference/layout.md` |
| `delight [target]` | Enhance | Add personality and memorable touches | `.agents/skills/impeccable/reference/delight.md` |
| `overdrive [target]` | Enhance | Push past conventional limits | `.agents/skills/impeccable/reference/overdrive.md` |
| `clarify [target]` | Fix | Improve UX copy, labels, and error messages | `.agents/skills/impeccable/reference/clarify.md` |
| `adapt [target]` | Fix | Adapt for different devices and screen sizes | `.agents/skills/impeccable/reference/adapt.md` |
| `optimize [target]` | Fix | Diagnose and fix UI performance | `.agents/skills/impeccable/reference/optimize.md` |
| `live` | Iterate | Visual variant mode: pick elements in the browser, generate alternatives | `.agents/skills/impeccable/reference/live.md` |
...
If the first word is `craft`, setup still runs first, but `.agents/skills/impeccable/reference/craft.md` owns the rest of the flow. If setup invokes `init` as a blocker, finish init, refresh context, then resume the original command and target.

`teach` is a deprecated alias for `init`: if the user types it, load `.agents/skills/impeccable/reference/init.md` and proceed as if they ran `init`.
